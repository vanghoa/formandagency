...
`;
    ...
    5. The artist had written accompanying notes - in the style of an unreliable narrator - for each of the artworks in the exhibition, that can be found within the exhibition’s microsite. See: www.formandagency.net. A larger wikipedia database had also been created on the occasion of the exhibition, which overlaps with the lore of the exhibition design by designer and artwork collaborator Darius Ou. See: https://form-and-agency.fandom.com/
    ...
    return (
        <>
            ...
            <ServerRender text={txt2} mwidth={800}></ServerRender>
            <ServerRender text={'<form>'} mwidth={1000}></ServerRender>
            <ServerRender text={txt3} mwidth={800}></ServerRender>
            <ServerRender text={'</form>'} mwidth={1000}></ServerRender>
